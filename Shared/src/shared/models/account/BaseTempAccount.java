...
public class BaseTempAccount<CollectionType extends BaseCollection, TempDeckType extends BaseTempDeck, MatchHistoryType extends BaseMatchHistory> {
  ...
  public BaseTempAccount(String username, String password, AccountType accountType,
      CollectionType collection) {
    this(username, password, accountType, collection, new ArrayList<>());
  }

  public BaseTempAccount(String username, String password, AccountType accountType,
      CollectionType collection, List<MatchHistoryType> matchHistories) {
    this(username, password, accountType, collection, matchHistories, new ArrayList<>(), null);
  }

  public BaseTempAccount(String username, String password, AccountType accountType,
      CollectionType collection, List<MatchHistoryType> matchHistories, List<TempDeckType> decks,
      String mainDeckName) {
