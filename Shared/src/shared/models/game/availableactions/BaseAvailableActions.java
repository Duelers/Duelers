...
public class BaseAvailableActions<
        InsertType extends BaseInsert,
        AttackType extends BaseAttack,
        MoveType extends BaseMove,
        TroopType extends Troop,
        GameMapType extends BaseGameMap<TroopType>,
        GameType extends BaseGame<PlayerType, GameMapType>,
        CardType extends Card,
        PlayerType extends BasePlayer<CardType, TroopType>
        > {
