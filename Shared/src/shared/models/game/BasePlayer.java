...
public class BasePlayer<CardType extends Card, TroopType extends Troop> {
  ...
  public BasePlayer(String userName, int currentMP, List<CardType> hand, List<CardType> graveyard,
      int playerNumber, List<TroopType> troops, TroopType hero) {
