...
public class BaseGameMap<TroopType extends Troop> {
  ...
  /**
   * If we want to add items to the board on startup (eg terrain, mana springs, etc) If can be
   * placed here by setting cell[x][y] as the item (0,4) | (2,5) | (4,4) are the correct coordinates
   * for mana springs.
   */
  public BaseGameMap() {
  ...
  /**
   * Get the 3x3 neighbours of a cell. Do not return the cell itself.
   */
  ...
  /**
   * Get the manhattan adjacent neighbours cell, not including diagonals. Do not return the cell
   * itself.
   */
