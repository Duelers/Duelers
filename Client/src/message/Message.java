...
public class Message {
    ...
    public static Message makeAttackMessage(String receiver, String myCardId, String opponentCardId) { // Client side
        Message message = new Message(receiver);
        message.otherFields = new OtherFields();
    ...
    public static Message makeAttackMessage(String receiver, Troop attacker, Troop defender, boolean counterAttack) { // GameCenter Side
        Message message = new Message(receiver);
    ...
    public static Message makeAcceptRequestMessage(String receiver, String opponentUsername) { // Client side
        Message message = new Message(receiver);
    ...
    public static Message makeAcceptRequestMessage(String receiver) { // GameCenter side
        Message message = new Message(receiver);
        message.messageType = MessageType.ACCEPT_REQUEST;
        return message;
    }
    ...
    public static Message makeDeclineRequestMessage(String receiver) { // GameCenter side
        Message message = new Message(receiver);
        message.messageType = MessageType.DECLINE_REQUEST;
        return message;
    }

    public static Message makeDeclineRequestMessage(String receiver, String opponentUsername) { // Client side
        Message message = new Message(receiver);
        message.messageType = MessageType.DECLINE_REQUEST;
        message.newGameFields = new NewGameFields();
        message.newGameFields.setOpponentUsername(opponentUsername);
    ...
    public static Message makeChangeCardNumberMessage(String receiver, Card card, int newValue) { // Same
        Message message = new Message(receiver);
