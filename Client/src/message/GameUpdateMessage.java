...
import localGameCenter.models.game.CellEffect;
...
public class GameUpdateMessage {
    ...
    public GameUpdateMessage(int turnNumber, int player1CurrentMP,  int player2CurrentMP, List<CellEffect> cellEffects) {
