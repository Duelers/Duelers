...
public class CardPane extends AnchorPane implements PropertyChangeListener {
    ...
    public CardPane(ICard card, boolean showPrice, boolean showCount, Deck deck) {
        ...
        apLabel = new DefaultLabel(String.valueOf(card.getDefaultAp()), AP_HP_FONT, Color.WHITE, AP_X, AP_HP_Y);
        hpLabel = new DefaultLabel(String.valueOf(card.getDefaultHp()), AP_HP_FONT, Color.WHITE, HP_X, AP_HP_Y);
