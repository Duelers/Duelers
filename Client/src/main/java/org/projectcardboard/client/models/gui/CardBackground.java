...
class CardBackground extends StackPane {
  ...
  static {
    try {
      InputStream troopBackgroundR =
          CardBackground.class.getResourceAsStream("/card_backgrounds/troop.png");
      InputStream spellBackgroundR =
          CardBackground.class.getResourceAsStream("/card_backgrounds/spell.png");
      InputStream glowR = CardBackground.class.getResourceAsStream("/card_backgrounds/glow.png");
      if (troopBackgroundR == null || spellBackgroundR == null || glowR == null) {
  ...
  CardBackground(ICard card) {
    backgroundView =
        ImageLoader.makeImageView(background.get(card.getType()), CARD_WIDTH, CARD_HEIGHT);
