...
public class DialogBox extends VBox {
  private static final CornerRadii DEFAULT_CORNER_RADIUS =
      new CornerRadii(UIConstants.DEFAULT_SPACING * 3);
  private static final Background DIALOG_BACKGROUND = new Background(
      new BackgroundFill(Color.rgb(255, 200, 200, 0.6), DEFAULT_CORNER_RADIUS, Insets.EMPTY));
