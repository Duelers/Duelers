...
public class UIConstants {
  ...
  private static final double CONFIG_SCREEN_WIDTH =
      Double.parseDouble(Config.getInstance().getProperty("CONFIG_SCREEN_WIDTH"));
  private static final double CONFIG_SCREEN_HEIGHT =
  ...
  public static final double SCALE = Math.min((CONFIG_SCREEN_WIDTH / DEFAULT_SCENE_WIDTH),
