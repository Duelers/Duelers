...
public class Message {
  ...
  public static Message makeRemoveCardFromDeckMessage(String receiver, String deckName,
      String cardId) {
    Message message = new Message(receiver);
    message.otherFields = new OtherFields();
    message.otherFields.setDeckName(deckName);
  ...
  public static Message makeMultiPlayerGameReQuestMessage(String receiver, GameType gameType,
  ...
  public static Message makeNewCustomGameMessage(String receiver, GameType gameType,
  ...
  public static Message makeChangeAccountTypeMessage(String receiver, String username,
