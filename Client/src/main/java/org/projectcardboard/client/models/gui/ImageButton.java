...
public class ImageButton extends StackPane {
  ...
  static {
    try {
      InputStream primaryDefaultR =
          ImageButton.class.getResourceAsStream("/ui/button_primary@2x.png");
      InputStream primaryGlowR =
          ImageButton.class.getResourceAsStream("/ui/button_primary_glow@2x.png");
  ...
  public ImageButton(String text, EventHandler<? super MouseEvent> mouseEvent, Image defaultImage,
      Image hoverImage) {
