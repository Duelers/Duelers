...
class PlayButtonImageZone extends StackPane {
    ...
    private static final double DESCRIPTION_WRAP = PlayButtonBox.BUTTON_WIDTH - UIConstants.DEFAULT_SPACING * 2;
    ...
    PlayButtonImageZone(PlayButtonItem item) {
        ...
        LinearVignette vignette = new LinearVignette(PlayButtonBox.BUTTON_WIDTH, PlayButtonBox.BUTTON_HEIGHT);
