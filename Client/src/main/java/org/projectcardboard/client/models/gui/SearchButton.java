...
class SearchButton extends Button {
  ...
  private static final Background DEFAULT_BACKGROUND =
      new Background(new BackgroundFill(Color.rgb(70, 70, 70, 0.6), CORNER, Insets.EMPTY));
  private static final Background HOVER_BACKGROUND =
      new Background(new BackgroundFill(Color.rgb(50, 50, 50, 0.8), CORNER, Insets.EMPTY));
