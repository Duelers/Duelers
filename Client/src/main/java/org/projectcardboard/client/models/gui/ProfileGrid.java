...
public class ProfileGrid extends GridPane {
    ...
    private static final String USERNAME_TEXT = LanguageData.getInstance()
            .getValue(new String[] { LanguageKeys.LOGIN_MENU, LanguageKeys.USERNAME });
    private static final String MATCH_HISTORY_TEXT = LanguageData.getInstance()
            .getValue(new String[] { LanguageKeys.PROFILE_MENU, LanguageKeys.MATCH_HISTORY });
    ...
    static {
        try {
            ...
            if (profilePicR == null || generalIconR == null || goldIconR == null || historyIconR == null) {
