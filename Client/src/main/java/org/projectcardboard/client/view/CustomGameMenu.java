...
class CustomGameMenu extends GameModeChooseMenu {
  private static final String BACKGROUND_URL = "/menu/background/custom_game_background.jpg";
  ...
  void startKillHero() {
    ...
    dialogBox.makeButton("START", buttonEvent -> {
      if (listView.getSelectionModel().getSelectedItem() == null)
        return;
      CustomGameMenuController.getInstance()
          .startGame(listView.getSelectionModel().getSelectedItem(), GameType.KILL_HERO);
