...
public class CollectionMenuController implements PropertyChangeListener {
  ...
  public void newDeck(String deckName) {
    Client.getInstance()
        .addToSendingMessagesAndSend(Message.makeCreateDeckMessage(SERVER_NAME, deckName));
  }
  ...
  public void removeDeck(String deckName) {
    Client.getInstance()
        .addToSendingMessagesAndSend(Message.makeRemoveDeckMessage(SERVER_NAME, deckName));
  }

  public void selectDeck(String deckName) {
    Client.getInstance()
        .addToSendingMessagesAndSend(Message.makeSelectDeckMessage(SERVER_NAME, deckName));
  }
  ...
  public void importDeck(ExportedDeck exportedDeck) {
    Client.getInstance()
        .addToSendingMessagesAndSend(Message.makeImportDeckMessage(SERVER_NAME, exportedDeck));
  }
}
