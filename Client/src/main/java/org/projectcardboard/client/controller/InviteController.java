...
public class InviteController {
  ...
  public void accept(String username) {
    Client.getInstance()
        .addToSendingMessagesAndSend(Message.makeAcceptRequestMessage(SERVER_NAME, username));
  }

  public void decline(String username) {
    Client.getInstance()
        .addToSendingMessagesAndSend(Message.makeDeclineRequestMessage(SERVER_NAME, username));
  }
}
