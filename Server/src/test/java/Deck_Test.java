...
public class Deck_Test {
    ...
    private ServerCard makeMinionCard() {
        return new ServerCard(" ", " ", " ", " ", CardType.MINION, false, new ArrayList<>(), 1, 1, 1, 1, AttackType.MELEE, 1);
    }

    private ServerCard makeGeneralCard() {
        return new ServerCard(" ", " ", " ", " ", CardType.HERO, false, new ArrayList<>(), 1, 1, 1, 1, AttackType.MELEE, 1);
    }
