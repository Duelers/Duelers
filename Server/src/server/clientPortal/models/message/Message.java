...
public class Message {
  ...
  public static Message makeChangeCardPositionMessage(String receiver, ServerCard card,
  ...
  public static Message makeAttackMessage(String receiver, ServerTroop attacker,
      ServerTroop defender, boolean counterAttack) {
    Message message = new Message(receiver);
    message.gameAnimations = new GameAnimations();
    message.gameAnimations.addAttacks(attacker.getCard().getCardId(),
        defender.getCard().getCardId());
    if (counterAttack)
      message.gameAnimations.addCounterAttacks(defender.getCard().getCardId(),
          attacker.getCard().getCardId());
  ...
  public static Message makeGameUpdateMessage(String receiver, int turnNumber, int player1CurrentMP,
      int player2CurrentMP, List<CellEffect> cellEffects) {
    Message message = new Message(receiver);
    message.gameUpdateMessage =
        new GameUpdateMessage(turnNumber, player1CurrentMP, player2CurrentMP, cellEffects);
  ...
  public static Message makeChatMessage(String receiver, String messageSender,
      String messageReceiver, String textMessage) {
    Message message = new Message(receiver);
  ...
  public static Message makeInvitationMessage(String receiver, String inviterUsername,
      GameType gameType) {
    Message message = new Message(receiver);
  ...
  public static Message makeChangeCardNumberMessage(String receiver, ServerCard card,
      int newValue) {
    Message message = new Message(receiver);
  ...
  public static Message makeCardsDrawnFromDeckMessage(String receiver, int deckSize,
      ServerCard... drawnCards) {
    Message message = new Message(receiver);
